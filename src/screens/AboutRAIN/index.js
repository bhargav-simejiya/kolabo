...
export class AboutRAIN extends Component {
  render() {
  ...
  renderMainView = () => {
    return (
      <SafeAreaView style={styles.container}>
        ...
        <ScrollView contentContainerStyle={{ flexGrow: 1, justifyContent: 'flex-end', alignItems: 'flex-end', }}>
          {this.renderUpperGreenContainer()}
          {this.renderIntroductionText()}
